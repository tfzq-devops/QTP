...
///科创板盘后固定价格委托
const char TF_OPT_KcCloseFixPrice = 'f'; 
...
///开始盘中挂载通道
const char TF_STS_LoadStarted = 'M'; 
...
/////////////////////////////////////////////////////////////////////////
///LoginTypeType是一个登录/登出类型
/////////////////////////////////////////////////////////////////////////
///登入
const char TF_LT_Login = '1'; 
///登出
const char TF_LT_Logout = '2'; 
      
/////////////////////////////////////////////////////////////////////////
///LoginFromType是一个登入方式类型
/////////////////////////////////////////////////////////////////////////
///未知
const char TF_LF_Unknown = '0'; 
///互联网网关
const char TF_LF_Internet = '1'; 
///api直连
const char TF_LF_LocalApi = '2'; 
      
/////////////////////////////////////////////////////////////////////////
///SubProductClassType是一个证券二级类别类型
/////////////////////////////////////////////////////////////////////////
///科创板股票
const char TF_SPC_KC = '1'; 
///其他
const char TF_SPC_Other = '0'; 
...
///终端名字长度的定义
const int TF_PROGRAMNAME_LEN = (64 + 1); 
///MAC地址列表长度的定义
